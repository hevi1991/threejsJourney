...
debugObject.portalColorStart = "#2a2ad7";
debugObject.portalColorEnd = "#d5e2ff";
gui.addColor(debugObject, "portalColorStart").onChange((v) => {
    portalLightMaterial.uniforms.uColorStart.value.set(v);
});
gui.addColor(debugObject, "portalColorEnd").onChange((v) => {
    portalLightMaterial.uniforms.uColorEnd.value.set(v);
});
...
gui.addColor(debugObject, "clearColor").onChange(() => {
    renderer.setClearColor(new THREE.Color(debugObject.clearColor));
});
