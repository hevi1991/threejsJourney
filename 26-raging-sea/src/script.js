...
const waterMaterial = new THREE.ShaderMaterial({
    ...
    uniforms: {
        uTime: { value: 0 },
        uBigWavesElevation: { value: 0.2 }, // 浪高y
        uBigWavesFrequency: { value: new THREE.Vector2(4, 1.5) }, // 浪频率
        uBigWavesSpeed: { value: 0.75 }, //浪动画速度
...
gui.add(waterMaterial.uniforms.uColorOffset, "value")
    ...
    .step(0.001)
    .name("uColorOffset");
gui.add(waterMaterial.uniforms.uColorMultipier, "value")
    .min(0)
    .max(10)
    .step(0.001)
    .name("uColorMultipier");
