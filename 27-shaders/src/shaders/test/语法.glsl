...
/// function
float sumAB(float a, float b) { return a + b; }
...
void main() {
  ...
  /* built-in function
  Many built-in classic functions sin, cos, max, min, pow exp, mod, floor, round
  clamp but also very practical functions like cross, dot, mix, step, smoothstep
