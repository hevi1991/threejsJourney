...
/**
 * - 可以使用Worker去优化加载。Example: https://pmndrs.github.io/cannon-es/examples/worker
 * - CANNON.js已经很久不更新了，使用CANNON-ES去替代，它是CANNON.js的fork后，仍在更新的版本。 https://pmndrs.github.io/cannon-es/docs/index.html
 */
...
world.broadphase = new CANNON.SAPBroadphase(world); // CANNON测试bodies间的碰撞【优化性能】
world.allowSleep = true; // bodies没有碰撞就不用去计算【优化性能】
...
const createSphere = (radius, position) => {
    ...
    body.addEventListener("collide", playHitSound); // Events
    world.addBody(body);
