...
// MeshStandardMaterial 基于物理的标准材质，支持光和表面的作用
const material = new THREE.MeshStandardMaterial();
material.metalness = 0.45; // 材质与金属的相似度。非金属材质，如木材或石材，使用0.0，金属使用1.0，通常没有中间值。 默认值为0.0。0.0到1.0之间的值可用于生锈金属的外观。如果还提供了metalnessMap，则两个值相乘。
material.roughness = 0.45; // 材质的粗糙程度。0.0表示平滑的镜面反射，1.0表示完全漫反射。默认值为1.0。如果还提供roughnessMap，则两个值相乘。
