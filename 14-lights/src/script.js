...
如果对光需求比较大，可以考虑将光源烘烤(baking)到纹理图上，再直接引入
*/
...
// 如果移动过SpotLight之后，SpotLightHelper的方向会错误，需要在下一帧更新才可显示正常。
window.requestAnimationFrame(() => {
    spotLightHelper.update();
});

const rectAreaLightHelper = new RectAreaLightHelper(rectAreaLight); // RectAreaLightHelper得去examples的jsm里头引入
